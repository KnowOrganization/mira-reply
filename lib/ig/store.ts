...
// Automation graph types now live in @shaiz/shared (single source). Imported
// here for internal use (IgStore fields) and re-exported below so existing
// `@/lib/ig/store` consumers keep resolving them.
import type {
  Automation,
  AutomationNode,
  AutomationEdge,
...
// ── Automation types ───────────────────────────────────────────────────────
// Canonical definitions live in @shaiz/shared (imported above for local use).
// Re-exported here so existing `@/lib/ig/store` consumers keep working.
export type {
  Automation,
  AutomationNode,
  AutomationEdge,
